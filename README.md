...
Clone the "Anatomy_2" file from my repo. <ins><i>(cloning helps with a lot of problems, so it is the best way to get this website to working.)</i></ins>

Inside your code editor change the current directry to Anatomy_2

After vite setup is done, Run ( npm install ) on the terminal of the code editor
